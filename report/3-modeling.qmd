...
| __Y__ | \boldmath$X_{f,s}, Y_h, W_h$ | Double ML |
| __Y__ | \boldmath$X_{f,s}, Y_h, W_h, \hat W_s$ | IV stage 2 |
| __Y__ | \boldmath$X_{f,s}, Y_h, W_h, Y_{control\: f}$ |  SC counterfactual |
| __W__ | \boldmath$X_{f,s}, Y_h, W_h$ | Propensity score, Double ML |
