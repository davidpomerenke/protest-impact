...
In the case of a single instrument and a single treatment, we can use indirect least squares [@dingFirstCourseCausal2023, ch. 23.6.2]. It is also known simply as _instrumental variable_ method, and -- especially in the case of a binary instrument -- the Wald estimator [@dingFirstCourseCausal2023, ch. 21].
