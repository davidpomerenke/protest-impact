...
# | fig-cap: "No controls. Results for regressing online newspaper coverage on protest occurrence without any controls (left) and controlling for weekdays and holidays (right)."
# | column: page
# | echo: false
...
# | fig-cap: Results for regressing online/print newspaper coverage on protest occurrence, controlling for weekdays and holidays and lagged values of media coverage and protest occurrence (n_lags=1).
# | column: page
# | echo: false
...
__Lagged controls:__ Increasing the number of lags does not substantially change the results.
