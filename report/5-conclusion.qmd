...
1. __Do protests distract from constructive discussion of the climate crisis?__
...
2. __How suitable are datasets from authorities or from semi-automatic collection and processing?__
...
My results contribute to closing the large research gap on causal methods that is attested by @jamesozdenLiteratureReviewProtest2022, and may serve as a baseline for further efforts.
...
- media coverage frames may not matter
- climate protests are pro status quo
