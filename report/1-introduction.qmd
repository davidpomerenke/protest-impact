...
__Forecasting.__ @ngSocialMediaActivity2022 evaluate classical and neural models for forecasting social media activity based on various factors, including exogenous protest events. They do not perform a causal analysis, but the models could be leveraged for causal analysis via double machine learning [@chernozhukovDoubleDebiasedMachine2017].
