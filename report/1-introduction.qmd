...
![Observable layers of public discourse. Adapted from a graphic from Stewart Brand [via @branderLayeredProtocols2022].](img/discourse-layering.png){.column-margin #fig-wheel}
...
!["Looking under the lamppost" by [Sketchplanations](https://sketchplanations.com/) (CC-BY-NC)](img/lamppost.png){.column-margin #fig-lamppost}
...
There has been little climate protest in Germany until 2018, with the exception of established environmental NGOs such as Greenpeace, and the activist formation _Ende Gelände_ (established 2015) that stages protests directly in coal mining areas. In the end of 2018, the climate movement has taken off with the founding of both the activist organization _Extinction Rebellion_ and the broad students' movement _Fridays for Future_. Since 2022 the activist formation _Letzte Generation_ is making the headlines. The smaller _End Fossil Occupy_ movement has started occupying universities mostly in 2023.

The movements pursue different strategies, resulting in different public reactions. Fridays for Future organizes legal protest marches, mostly on Friday. They have been criticized for breaking the rules, and even
