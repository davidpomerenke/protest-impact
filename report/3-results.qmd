...
@fig-sc-180 shows the fit for the optimized unbiased model (specifically: unbiased for estimating the -day cumulative coverage). @fig-sc-22 shows the fit for a shorter pre-treatment period and with better pre-treatment fit.

```{python}
# | fig-label: fig-sc-180
...
```{python}
# | fig-label: fig-placebo-treatment-regional
...
```{python}
# | fig-label: fig-placebo-treatment-global
...
```{python}
# | fig-label: fig-impact-dims
# | fig-caption: 7-day cumulative causal impact estimates by method. Error bars are 95% confidence intervals. Pay attention to differing y-axis scaling.
# | column: page
# | echo: false
...
```{python}
# | fig-label: fig-impact-groups-2
# | fig-caption: 2-day cumulative causal impact estimates by protest group, as estimated by the synthetic control method. Error bars are 95% confidence intervals. Pay attention to differing y-axis scaling.
# | column: page
# | echo: false
...
```{python}
# | fig-label: fig-impact-groups-7
# | fig-caption: 7-day cumulative causal impact estimates by protest group, as estimated by the synthetic control method. Error bars are 95% confidence intervals. Pay attention to differing y-axis scaling.
# | column: page
# | echo: false
