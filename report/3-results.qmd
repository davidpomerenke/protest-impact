...
Out of the 15 potential instrumental variables, 5 pandemic instruments and 4 weather instruments have a statistically significant impact on protest occurrence (see @fig-iv-basic), but when using them in a combined regression the coefficients are much less significant.
...
ax.set_title("First stage placebo tests with shifted outcome: Impact of pc_resid_9 on protest occurrence")
plt.tight_layout()
plt.show()
```
