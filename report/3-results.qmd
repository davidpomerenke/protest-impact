...
sc_plot(scale="demean", pre_period=22, post_period=22)
```
...
sc_plot(scale="demean", rolling=7, pre_period=12 * 28, post_period=3 * 28)
```
...
logistic regression unbalanced with diffs, ewms, sizes
...
fig, axes = plot_trends(cumulative=False, steps=range(-28, 8))
