---
title: Impact of protest movements
jupyter: python3
---
...
Causal inference can help to solve this problem. In my thesis I want to focus on a recent technique that uses natural language processing for removing confounders:
